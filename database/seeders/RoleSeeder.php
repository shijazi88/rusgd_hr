...
class RoleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $directorPerms = $allPerms->only(['view_employees','edit_employees','approve_leaves','approve_purchases','view_payroll','manage_rules','manage_departments','manage_contract_types','view_reports','manage_shifts','manage_periods'])->values()->all();
        $managerPerms  = $allPerms->only(['view_employees','approve_leaves','approve_purchases','view_payroll','manage_shifts'])->values()->all();
        $hrPerms       = $allPerms->only(['view_employees','edit_employees','approve_leaves','approve_purchases','manage_departments','manage_contract_types','manage_company_settings','manage_shifts','manage_periods','view_payroll','view_reports'])->values()->all();
